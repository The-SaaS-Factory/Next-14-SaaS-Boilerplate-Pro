...
const testimonials: any[] = [
  ...
  {
    body: "Mi tienda en línea ha experimentado un aumento notable en las ventas desde que opté por este hosting. La interfaz es amigable, y la asistencia técnica siempre está lista para ayudar. ¡Muy satisfecha con los resultados y el impacto en mi agencia!.",
    author: {
      name: "Lucía M. ",
